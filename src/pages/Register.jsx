...
/**
 * Register Page - Theme-aware with designer credit
 */
const Register = () => {
      ...
      <div className={`w-full max-w-md rounded-3xl shadow-2xl p-8 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {errors.agreeToTerms && (
              <p className="text-red-500 text-sm mt-1 ml-1">{errors.agreeToTerms}</p>
            )}
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl font-bold bg-green-500 hover:bg-green-600 text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] shadow-lg mt-2"
          >
            {loading ? (
